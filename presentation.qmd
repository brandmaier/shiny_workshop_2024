...
Copy the code from the previous slide (or open `demo/demo1.R`) and run it in R
...
::: {.code-file .sourceCode .cell-code}
`r fontawesome::fa("file")` `R/solution1.R`
:::
...
::: {.code-file .sourceCode .cell-code}
`r fontawesome::fa("file")` `R/solution2.R`
:::
...
To the extent possible under law and unless otherwise noted, Andreas and Leonie have waived all copyright and related or neighboring rights to this workshop. This work is published from: Deutschland.
